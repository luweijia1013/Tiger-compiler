...
typedef struct F_access_ *F_access;//added
typedef struct F_accessList_ *F_accessList;//added
...
struct F_frame_{
  Temp_label name;//function name
  F_accessList formals;//whether parameter is escaped
  int local_count;//don't know
};

/* give a function name and escape list
 * return a F_frame which is a stack abstraction
 */
